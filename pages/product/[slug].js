...
const Slug = ({ addToCart }) => {
  ...
  const checkServersbility = async () => {
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pincode ml-2 mt-6 flex space-x-7 text-sm">
                <input
                  type="text"
                  onChange={onChangePin}
                  className="p-2  border-2 border-gray-300 focus:outline-none rounded-md"
              ...
              {service && service != null && (
                <div className="text-green-900 ml-3 text-sm mt-3">
